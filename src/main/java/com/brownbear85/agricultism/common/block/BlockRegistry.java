...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> OAK_CARPET = register("oak_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.DECORATION).strength(2.0F).sound(SoundType.WOOD)), ItemRegistry.properties());
    ...
    public static final RegistryObject<Block> CRIMSON_CARPET = register("crimson_carpet", () -> new CarpetBlock(BlockBehaviour.Properties.of(Material.DECORATION).strength(2.0F).sound(SoundType.WOOD)), ItemRegistry.properties());
